...
{
    [Description("Triggers whenever a account is updated in CRM")]
    public class AccountUpdated : Event
    {
        public static AccountUpdated Example = new AccountUpdated()
        {
        ...
        [Description("The Account Blocking reason")]
        ...
        [Description("The Account ProspectNo")]
        ...
        [Description("The Account Origin name")]
