...
| [Middleware Guidelines](docs/middleware-guidelines.md) | Decision guide: when, why, and what to use pipeline middleware for (vs. observers, handlers, instrumentation, retry) |
