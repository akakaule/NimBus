...
export class Client extends ApiClientBase {
     ...
     * @return OK
     */
    postAgentMappings(body?: ProposeMappingRequest | undefined): Promise<MappingInfo> {
        let url_ = this.baseUrl + "/api/agent/mappings";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processPostAgentMappings(_response);
        });
    }

    protected processPostAgentMappings(response: Response): Promise<MappingInfo> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MappingInfo.fromJS(resultData200);
            return result200;
            });
        } else if (status === 404) {
            return response.text().then((_responseText) => {
            return throwException("Source or target event type not found", status, _responseText, _headers);
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        ...
        return Promise.resolve<MappingInfo>(null as any);
    }
     ...
     * @return OK
     */
    getAgentMappings(): Promise<MappingInfo[]> {
        let url_ = this.baseUrl + "/api/agent/mappings";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetAgentMappings(_response);
        });
    }

    protected processGetAgentMappings(response: Response): Promise<MappingInfo[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(MappingInfo.fromJS(item));
            }
            else {
                result200 = null as any;
            }
     ...
     * @return OK
     */
    postAgentMappingApprove(id: string): Promise<void> {
        let url_ = this.baseUrl + "/api/agent/mappings/{id}/approve";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processPostAgentMappingApprove(_response);
        });
    }

    protected processPostAgentMappingApprove(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            return response.text().then((_responseText) => {
            return throwException("Mapping not found", status, _responseText, _headers);
            });
        } else if (status === 409) {
            return response.text().then((_responseText) => {
            return throwException("Source schema has drifted; mapping marked Stale", status, _responseText, _headers);
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
     ...
     * @return OK
     */
    postAgentMappingReject(id: string): Promise<void> {
        let url_ = this.baseUrl + "/api/agent/mappings/{id}/reject";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processPostAgentMappingReject(_response);
        });
    }

    protected processPostAgentMappingReject(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    postAgentMappingPause(id: string): Promise<void> {
        let url_ = this.baseUrl + "/api/agent/mappings/{id}/pause";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processPostAgentMappingPause(_response);
        });
    }

    protected processPostAgentMappingPause(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    postAgentMappingResume(id: string): Promise<void> {
        let url_ = this.baseUrl + "/api/agent/mappings/{id}/resume";
        if (id === undefined || id === null)
            throw new globalThis.Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processPostAgentMappingResume(_response);
        });
    }

    protected processPostAgentMappingResume(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class ProposeMappingRequest implements IProposeMappingRequest {
    sourceEventTypeId!: string;
    targetEventTypeId!: string;
    transform!: string;
    sourceSchemaHash!: string;
    rationale?: string | undefined;
    workedExamplesJson?: string | undefined;

    [key: string]: any;

    constructor(data?: IProposeMappingRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.sourceEventTypeId = _data["sourceEventTypeId"];
            this.targetEventTypeId = _data["targetEventTypeId"];
            this.transform = _data["transform"];
            this.sourceSchemaHash = _data["sourceSchemaHash"];
            this.rationale = _data["rationale"];
            this.workedExamplesJson = _data["workedExamplesJson"];
        }
    }

    static fromJS(data: any): ProposeMappingRequest {
        data = typeof data === 'object' ? data : {};
        let result = new ProposeMappingRequest();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["sourceEventTypeId"] = this.sourceEventTypeId;
        data["targetEventTypeId"] = this.targetEventTypeId;
        data["transform"] = this.transform;
        data["sourceSchemaHash"] = this.sourceSchemaHash;
        data["rationale"] = this.rationale;
        data["workedExamplesJson"] = this.workedExamplesJson;
        return data;
    }

    clone(): ProposeMappingRequest {
        const json = this.toJSON();
        let result = new ProposeMappingRequest();
        result.init(json);
        return result;
...
export interface IProposeMappingRequest {
    sourceEventTypeId: string;
    targetEventTypeId: string;
    transform: string;
    sourceSchemaHash: string;
...
export class MappingInfo implements IMappingInfo {
    id?: string;
    sourceEventTypeId?: string;
    targetEventTypeId?: string;
    transform?: string;
    ...
    static fromJS(data: any): MappingInfo {
        data = typeof data === 'object' ? data : {};
        let result = new MappingInfo();
        result.init(data);
        return result;
    }
