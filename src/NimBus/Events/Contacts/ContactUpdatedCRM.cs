...
{
    [Description("Triggers whenever a contact is updated in CRM")]
    public class ContactUpdatedCRM : Event
    {
        public static ContactUpdatedCRM Example = new ContactUpdatedCRM()
        {
        ...
        [Description("The contact updated on date")]
