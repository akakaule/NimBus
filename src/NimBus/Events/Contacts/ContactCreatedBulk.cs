...
{
    [Description("Triggers whenever a account is created in Nav09")]
    public class ContactCreatedBulk : Event
    {
        public static ContactCreatedBulk Example = new ContactCreatedBulk()
        {
